...
//
//  Created by Banavath, Naresh on 22/07/25.
//
...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchesFixedTestAccountData() {
        ...
        case let .success(imageFeed):
            ...
            /// If you have finite number of items, you can assert each item individually. for better assertion
            ...
            /// If you have large number of items, you can use enumerated to assert each item
